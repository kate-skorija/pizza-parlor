...
This website demonstrates what I've learned this week about object oriented programming with JavaScript. Hot Pies is a fictional pizza restaurant, and its website lets users add pizzas to an order, providing them with an order price dependent upon their selections. My work for this webiste is focused on using constructors and prototypes in JavaScript. You may view the published site on [GitHub Pages](https://kate-skorija.github.io/pizza-parlor/).
